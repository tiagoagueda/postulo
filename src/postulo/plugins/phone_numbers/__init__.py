"""The feature that keeps several telephone numbers per person, on or off.
...
this capability is offered*, and that is all this package holds. It is a package rather
than a module in `core` because it was written there once, a week after the documentation
said not to, and nothing pulled the other way (#129).
"""
