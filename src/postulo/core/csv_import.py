...
CHANNEL_ALIASES: dict[str, str] = {
    ...
    "indicacao": "referral",
    "referência": "referral",
    # The public employment service's own listings (#202), by the names people write.
    "employment service": "employment_service",
    "public employment service": "employment_service",
    "employment office": "employment_service",
    "job centre": "employment_service",
    "jobcentre": "employment_service",
    "jobcenter": "employment_service",
    "france travail": "employment_service",
    "pôle emploi": "employment_service",
    "pole emploi": "employment_service",
    "iefp": "employment_service",
    "centro de emprego": "employment_service",
    "sepe": "employment_service",
    "arbeitsagentur": "employment_service",
    "agentur für arbeit": "employment_service",
    "uwv": "employment_service",
    "recruiter": "recruiter",
    "agency": "recruiter",
